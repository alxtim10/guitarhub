...
Route::get('/GetAllCategoryByStoreId', [CategoryController::class, 'GetAllCategoryByStoreId']);
...
Route::post('/CancelTransactionStatus', [TransactionController::class, 'CancelTransactionStatus']);
