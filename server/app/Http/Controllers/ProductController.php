        ...
        $customResponse = [
            ...
            'data' => $datas->map(function ($data) {
                return [
                    ...
                    'category_name' => strval($data->category_id) . ' - ' . Category::where('id', $data->category_id)->value('name'),
                    'store_name' => strval($data->store_id) . ' - ' . Store::where('id', $data->store_id)->value('name'),
    ...
    public function GetProductById(Request $request)
    {
        ...
        $customResponse = [
            ...
            'data' => [
                ...
                'store' => Store::where('id', $data->store_id)->first(),
                'rating' => $data->rating,
                'image_url' => ProductImage::where('product_id', $id)->value('image_url'),
                'stock_quantity' => $data->stock_quantity,
                'discount_percentage' => $data->discount_percentage,
                'discount_start_date' => $data->discount_start_date,
                'discount_end_date' => $data->discount_end_date,
